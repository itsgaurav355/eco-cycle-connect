          ...
          <div className="row">
            ...
            <div className="col-3">
              ...
              <div className="footer-links d-flex flex-column">
                ...
                <Link to="/refurn-policy" className="text-white py-2 mb-1">Refund Policy</Link>
                <Link to="/shipping-policy" className="text-white py-2 mb-1">Shipping Policy</Link>
                <Link to="/term-and-conditions-policy" className="text-white py-2 mb-1">Terms & Conditions</Link>
